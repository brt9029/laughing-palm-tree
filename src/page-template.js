function generateManagerCard(manager) {
    return `
        <div class="card col-3 m-3 bg-danger shadow">
            <h5 class="card-title text-center pt-2 text-white">${manager.name}</h5>
                <div class="card-body">
...
function generateEngineerCard(engineer) {
    return `
    <div class="card col-3 m-3 bg-warning shadow">
            <h5 class="card-title text-center pt-2 text-white">${engineer.name}</h5>
                <div class="card-body">
...
function generateInternCard(intern) {
    return `
    <div class="card col-3 m-3 bg-success shadow">
            <h5 class="card-title text-center pt-2 text-white">${intern.name}</h5>
                <div class="card-body">
